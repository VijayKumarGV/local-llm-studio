...
def read_file(filepath: str, max_lines: int = 200) -> dict[str, Any]:
    ...
    try:
        ...
        return {"status": "success", "filepath": filepath, "content": "".join(lines)}
    except Exception as e:
        return {"status": "error", "error": str(e)}
...
AVAILABLE_TOOLS = [
    ...
    },
    {
        ...
        "parameters": {
            "type": "object",
            "properties": {"url": {"type": "string", "description": "Full http:// or https:// URL to fetch."}},
            "required": ["url"],
        },
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "note_key": {
                    "type": "string",
                    "description": "Optional short label (e.g. 'plan', 'todo', 'constraint').",
                },
            },
            "required": ["text"],
        },
    ...
    },
    {
        ...
        "parameters": {
            "type": "object",
            "properties": {"code": {"type": "string", "description": "Executable Python code snippet."}},
            "required": ["code"],
        },
    },
    {
        ...
        "parameters": {
            "type": "object",
            "properties": {"filepath": {"type": "string", "description": "Relative path to file in workspace."}},
            "required": ["filepath"],
        },
    },
    {
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {
                    "type": "string",
                    "description": "Filename with extension (e.g. 'app.py', 'dashboard.html', 'report.md')",
                },
                "content": {"type": "string", "description": "Complete file content to be written."},
                "artifact_type": {
                    "type": "string",
                    "enum": ["code", "markdown", "html", "document", "svg", "data"],
                    "description": "Type of artifact.",
                },
                "language": {
                    "type": "string",
                    "description": "Programming or markup language (e.g. 'python', 'javascript', 'html')",
                },
            },
